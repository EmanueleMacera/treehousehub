            ...
            <div class="rentals-grid">
                @foreach ($structures as $structure)
                    <article class="rental-card">
                        <a class="rental-card__media" href="{{ route('rentals.show', ['locale' => app()->getLocale(), 'slug' => $structure->slug]) }}">
                        ...
                        <div class="rental-card__body">
                            ...
                            <a class="rental-card__link" href="{{ route('rentals.show', ['locale' => app()->getLocale(), 'slug' => $structure->slug]) }}">
